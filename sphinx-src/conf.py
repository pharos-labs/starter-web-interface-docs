# -*- coding: utf-8 -*-
#
# Starter Web Interface Documentation build configuration file.
#
...
if variant == 'mosaic':
    ...
    project = u'Mosaic Starter Web Interface'
    ...
    """
    for filename in glob.glob(os.path.join('..', 'img', 'mosaic', '*.*')):
        shutil.copy(filename, 'vendor_img')
else:
    ...
    .. |Designer| replace:: Designer
    """
    for filename in glob.glob(os.path.join('..', 'img', 'pharos', '*.*')):
        shutil.copy(filename, 'vendor_img')
...
version = u'8.0.2 Beta 2'
# The full version, including alpha/beta/rc tags.
release = u'8.0.2 Beta 2'
...
latex_documents = [('index', 'starterwebinterface.tex', project, author, 'manual')]
